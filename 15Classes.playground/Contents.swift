...
class MotorVehicle : Vehicle {
    ...
    init(passengers: Int, zeroTo60: Float, fluelEfficiency: Int) {
        self.fuelEfficiency = fluelEfficiency
        super.init(passengers: passengers, zeroTo60: zeroTo60)
    }
}
...
let bugattiVeyron = MotorVehicle(passengers: 2, zeroTo60: 2.5, fluelEfficiency: 7)
